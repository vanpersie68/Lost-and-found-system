...
@Slf4j
@ApiOperation(value = "Backend Code Generator") //后端代码生成器
public class MyBatisPlusUtils {
    ...
    @ApiModelProperty(value = "Class notes")  // 类备注
    private String description = "";

    @ApiModelProperty(value = "Author")  // 作者
    private static final String author = "5619Team";

    @ApiModelProperty(value = "Database table prefix")  // 数据库表前缀
    private static final String tablePre = "a_";

    @ApiModelProperty(value = "Primary key data type")  // 主键类型
    private static final String primaryKeyType = "String";

    @ApiModelProperty(value = "Entity class corresponding package")  // 实体类对应包
    private String entityPackage = "";

    @ApiModelProperty(value = "DAO corresponding package")  // dao对应包
    private String daoPackage = "";

    @ApiModelProperty(value = "Service corresponding package")  // service对应包
    private String servicePackage = "";

    @ApiModelProperty(value = "ServiceImpl corresponding package")  // serviceImpl对应包
    private String serviceImplPackage = "";

    @ApiModelProperty(value = "Controller corresponding package")  // controller对应包
    private String controllerPackage = "";

    @ApiOperation(value = "Generate code")  // 生成代码
    ...
    private void createNewCode(GroupTemplate gt) throws IOException {
        ...
        log.info("[Code Generation Successful]" + DateUtil.now());
    }
    ...
    private void removeNewCode(String className) {
        ...
        log.info("[Code Deletion Successful]" + DateUtil.now());
    }

    @ApiOperation(value = "Dot to Slash Conversion")
    public static String dotToLine(String dotContext) {
        return dotContext.replace(".", "/");
    }

    @ApiOperation(value = "Camel Case to Underscore Conversion")
    ...
    @ApiOperation(value = "Whether the first letter is uppercase or lowercase")  // 首字母是否大小写
    public static String name(String classTitle, boolean isFirstUpper) {
        if (ZwzNullUtils.isNull(classTitle)) {
            throw new ZwzException("The length of the class name must be a positive number");  // 类名的长度必须是正数
        }
