...
public class ResponseUtil {
    ...
    @ApiModelProperty(value = "output JSON")
    public static void out(HttpServletResponse httpServletResponse, Map<String, Object> responseMap){
        ...
        try {
            ...
            log.warn(exception + "Error in Converting Response to JSON"); //Response转换JSON错误
        } finally{
    ...
    public static Map<String, Object> resultSuccessMap(){
        return resultMap(true, 200, "Operation successful", null);
    }
}
