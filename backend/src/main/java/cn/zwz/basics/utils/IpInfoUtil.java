...
@ApiOperation(value = "IP Geolocation Utility Class") //IP定位工具类
@Slf4j
@Component
public class IpInfoUtil {

    @ApiModelProperty(value = "Tencent Maps API Key") //腾讯地图的KEY值
    ...
    public String getIpCity(HttpServletRequest request){
        ...
        try {
            ...
            log.warn("County or district query failed"); //区县查询失败
        }
        return resultStr;
    }

    @ApiOperation(value = "IP address of the query request") //查询请求的IP地址
