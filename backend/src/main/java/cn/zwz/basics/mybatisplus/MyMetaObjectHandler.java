...
@ApiOperation(value = "MybatisPlus Field Filling") // MybatisPlus字段填充
@Slf4j
@Component
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    private static final String DEFALUT_STR = "API interface"; // API接口

    @Override
    @ApiOperation(value = "Fill method for addition")  // 新增方法填充
    ...
    @Override
    @ApiOperation(value = "Fill method for editing") // 编辑方法填充
