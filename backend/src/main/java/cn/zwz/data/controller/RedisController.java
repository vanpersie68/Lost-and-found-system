...
@RestController
@Api(tags = "Cache management interface")
@RequestMapping("/zwz/redis")
@Transactional
public class RedisController {

    @ApiModelProperty(value = "Maximum number of key values")
    ...
    @ApiOperation(value = "Get real-time key size")
    ...
    @ApiOperation(value = "Get real-time memory size")
    ...
    @ApiOperation(value = "Query Redis data")
