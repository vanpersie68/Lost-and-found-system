...
@Slf4j
@Controller
@Api(tags = "File management interface")
...
public class FileController {
    ...
    @SystemLog(about = "Query system files", type = LogType.DATA_CENTER,doType = "FILE-01")
    @RequestMapping(value = "/getByCondition", method = RequestMethod.GET)
    @ApiOperation(value = "Query system files")
    @ResponseBody
    ...
    @SystemLog(about = "File copy", type = LogType.DATA_CENTER,doType = "FILE-02")
    @RequestMapping(value = "/copy", method = RequestMethod.POST)
    @ApiOperation(value = "File copy")
    @ResponseBody
    ...
    @SystemLog(about = "File rename", type = LogType.DATA_CENTER,doType = "FILE-03")
    ...
    @SystemLog(about = "File rename", type = LogType.DATA_CENTER,doType = "FILE-04")
    ...
    @SystemLog(about = "Preview file", type = LogType.DATA_CENTER,doType = "FILE-05")
    @RequestMapping(value = "/view/{id}", method = RequestMethod.GET)
    @ApiOperation(value = "Preview file")
    public void view(@PathVariable String id,@RequestParam(required = false) String filename,@RequestParam(required = false, defaultValue = "false") Boolean preview,HttpServletResponse httpServletResponse) throws IOException {
        ...
        if(selectFile == null){
            throw new ZwzException("file does not exist");
        }
