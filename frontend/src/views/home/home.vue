        ...
        <div class="body">
            ...
            <div class="awayMenu">
                ...
                <div class="awayLeft">
                    ...
                    <!--登入地址 -->
                    <div class="manage">IP address: local test</div><!--{{ location }}-->
                </div>
                <!--时间，上下布局 -->
                <div class="bottom">
                    <!--年月日 -->
                ...
                <div class="threeButton">
                    ...
                    <div class="button" @click="toJingBanPage">
                        <div class="left">
                            ...
                            <!--内容3 -->
                            <span class="text">Continue doing</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bottomText" @click="toOwnMenu">
                Add "common modules"? Click me to enter personal portal settings
            </div>
        </div>
    </Row>
</div>
...
export default {
    ...
    methods: {
        ...
        toDaiBanPage() {
            this.$Message.success("Under development, please stay tuned!");
        },
        toFaQiPage() {
            this.$Message.success("Under development, please stay tuned!");
        },
