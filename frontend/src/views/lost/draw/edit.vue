    ...
    <Card>
        <div slot="title">
            <div class="edit-head">
                ...
                <div class="head-name">Edit found items</div>
                <span></span>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="Pick up time" prop="time">
                <DatePicker type="date" format="yyyy-MM-dd" @on-change="changeDate" clearable :placeholder="form.time" style="width:570px"></DatePicker>
            </FormItem>
