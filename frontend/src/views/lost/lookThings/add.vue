        ...
        <Card>
            <div slot="title">
                <div class="edit-head">
                    ...
                    <div class="head-name">Add Lost Item</div>
                    <span></span>
            ...
            <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
                ...
                <FormItem label="Time Lost" prop="time">
                    <DatePicker type="date" format="yyyy-MM-dd" @on-change="changeDate" placeholder="Please select the time lost..." clearable style="width:570px"></DatePicker>
                </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    addLookThings(this.form).then(res => {
