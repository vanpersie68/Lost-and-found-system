                ...
                <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                    <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                        <Form-item label="" prop="content">
                            <Input type="text" v-model="searchForm.content" placeholder="Message Content" clearable style="width: 150px" />
                        </Form-item>
                        <Form-item label="" prop="userName">
                            <Input type="text" v-model="searchForm.userName" placeholder="Message Sender" clearable style="width: 150px" />
                        </Form-item>
...
export default {
    ...
    return {
        ...
        formData: {},
        currView: "index",
        loading: true, // Table loading state
        searchForm: { // Search form initialization object
            pageNumber: 1, // Current page number
            pageSize: 15, // Page size
            sort: "createTime", // Default sorting field
            order: "desc", // Default sorting order
        },
        selectList: [], // Multiple selection data
        selectCount: 0, // Multiple selection count
        selectRow: 0,
        columns: [
            // Table header
            {
