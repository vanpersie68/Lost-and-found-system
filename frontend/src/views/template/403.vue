<template>
      ...
      <div class="error403-body-con">
        <Card>
          ...
          <div class="error403-btn-con">
            ...
            <Button @click="goHome" size="large" style="width: 200px;" type="text">Go Back to Home</Button>
            <!-- "Return to Previous Page" Button -->
            <Button @click="backPage" size="large" style="width: 200px;margin-left: 40px;" type="primary">Go Back to Previous Page</Button>
          </div>
        </Card>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      goHome() {
        // Navigate to the home page (assuming 'home_index' is a valid route name)
        this.$router.push({
          name: 'home_index'
        });
      }
